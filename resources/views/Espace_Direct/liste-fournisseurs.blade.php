			...
			<div class="container-fluid">
				...
				<div class="row">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="{{ Route('direct.delete', ['p_table'=>'fournisseurs','p_id'=> $item->id_fournisseur ] ) }}" type="button" class="btn btn-outline btn-danger btn-xs">Effacer</a>
										</td>
									</tr>
									@endforeach
									@endif
					...
					<div class="col-lg-12">
						...
						<a href="{{ Route('direct.addForm' ,['param' => 'fournisseur']) }}" type="button" class="btn btn-outline btn-info">Ajouter fournisseur</a>
