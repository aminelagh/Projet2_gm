...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">{{ $data->libelle }} </h1>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="col-lg-4">
								...
								<a href="{{ Route('admin.updateUser',['id' => 0 ]) }}" type="button" class="btn btn-outline btn-info"> Modifier </a>
