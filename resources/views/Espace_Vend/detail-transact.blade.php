    ...
    <div class="row">
      ...
      <div class="table-responsive">
           ...
           <tbody>
             ...
             $i=0;
             $montant=0;
              $totalHT= number_format(getChamp('articles','id_article',$item->id_article, 'prix_vente') * $item->quantite,2,',','');
             ...
             @endforeach
<tr><td colspan="4" align="right"> <h3>Montant total HT : </h3></td><td align="right"><h3>{{ $montant }} DH</h3></td></tr>
             @endif
